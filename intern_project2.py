...
def data_analysis():
    df = pd.read_csv('C:/Users/harikrishna/OneDrive/Documents/project/House price prediction project/house_price_prediction_dataset.csv')
...
def internship():
    ...
    st.write('Student Name: Harikrishna')
    st.write('Student ID: 12345')
    st.write('Program: Computer Science and Engineering')
